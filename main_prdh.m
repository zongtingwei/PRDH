...
for data = 1:length(dataNameArray)
    ...
    for i = 1:iterator
        ...
        % return cell "outcome" as results, PRDH is the algorithm
        [outcome{i, 1}, outcome{i, 2}, outcome{i, 3}, outcome{i, 4}, outcome{i, 5}, outcome{i, 6}, outcome{i, 7}] = PRDH(train_F, train_L, i);
        ...
        for j = 1:size(Tgood, 1) % test population "unionPF" on test set
            ...
            mdl = fitcknn(CInsTrain, train_L, 'NumNeighbors', 5);
